...
```
		...
		"org1": {
			...
			"peer1": {
				"requests": "grpc://x.x.x.x:7051",
				"events": "grpc://x.x.x.x:7053",
				...
			},
			"peer2": {
				"requests": "grpc://x.x.x.x:7056",
				"events": "grpc://x.x.x.x:7058",
				...
			}
		},
		"org2": {
			...
			"peer1": {
				"requests": "grpc://x.x.x.x:8051",
				"events": "grpc://x.x.x.x:8053",
				...			},
			"peer2": {
				"requests": "grpc://x.x.x.x:8056",
				"events": "grpc://x.x.x.x:8058",
				...
			}
		}
